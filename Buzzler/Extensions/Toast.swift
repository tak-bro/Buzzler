...
class Toast {
    static func show(message: String, controller: UIViewController, dismissHandler: (() -> ())? = nil) {
        ...
        toastLabel.font = UIFont(name: "NotoSans-Regular", size: 12)
        ...
        let c3 = NSLayoutConstraint(item: toastContainer, attribute: .bottom, relatedBy: .equal, toItem: controller.view, attribute: .bottom, multiplier: 1, constant: -70)
