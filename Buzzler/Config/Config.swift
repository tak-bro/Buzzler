...
struct Config {
    ...
    struct UI {
        ...
        static let errorColor = UIColor(red: 227.0 / 255.0, green: 64.0 / 255.0, blue: 84.0 / 255.0, alpha: 1.0)
        static let placeholderColor = UIColor(red:0.78, green:0.78, blue:0.80, alpha:1.00)
        static let heartColor = UIColor(red:0.95, green:0.36, blue:0.45, alpha:1.0)
        
        static let blackTransparencyColor = UIColor(red: 0, green: 0, blue: 0, alpha: 0.4)
        static let uploadingColor = UIColor(red: 210.0 / 255.0, green: 234.0 / 255.0, blue: 234.0 / 255.0, alpha: 1.0)
